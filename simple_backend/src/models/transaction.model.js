...
class Transaction {
  ...
  // query dimodif pakai JOIN ke tabel items buat dapetin item_name
  ...
  // fungsi baru pakee agregasi SUM buat ngitung total pengeluaran
  static async getTotalSpentByUserId(userId){
    const result = await db.query(
